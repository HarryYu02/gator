...
SELECT
    ff.id, ff.created_at, ff.updated_at, ff.user_id, feed_id, f.id, f.created_at, f.updated_at, f.name, url, f.user_id, last_fetched_at, u.id, u.created_at, u.updated_at, u.name,
    u.name AS user_name,
    f.name AS feed_name
